...
namespace FoodDiary.Infrastructure.Migrations
{
    ...
    [Migration("20250808173048_RemoveUserIdFromRecipes")]
    partial class RemoveUserIdFromRecipes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodDiary.Core.RecipeAggregate.RecipeFavorite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "RecipeId", "RelationshipType")
                        .IsUnique();
